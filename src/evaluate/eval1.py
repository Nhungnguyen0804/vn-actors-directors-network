...
def evaluate_model(model_name: str, dataset: List[Dict], batch_size: int = 1): # batch size 10 => 200 batch, 100 => 20 batch
    ...
    # Save to CSV
    csv_filename = "data/datgemini_evaluation_results_1.csv"
